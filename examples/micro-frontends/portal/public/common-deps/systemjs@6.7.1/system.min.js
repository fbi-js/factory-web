...
!(function () {
  ...
  function l(t, n, r) {
    ...
    w && Object.defineProperty(s, w, { value: 'Module' })
    ...
    ;[].forEach.call(document.querySelectorAll('script'), function (t) {
      if (!t.sp)
        if ('systemjs-module' === t.type) {
          ...
          t.sp = !0
          var i = t.src
            ? fetch(t.src, { integrity: t.integrity }).then(function (e) {
                return e.text()
              })
            : t.innerHTML
          M = M.then(function () {
            ...
            !(function (t, i, o) {
              try {
                ...
                throw Error(e(1, 'systemjs-importmap contains invalid JSON'))
              }
              !(function (e, t, i) {
                var o
  ...
  if (!h && 'undefined' != typeof location) {
    var S = (h = location.href.split('#')[0].split('?')[0]).lastIndexOf('/')
    ;-1 !== S && (h = h.slice(0, S + 1))
  }
  var b,
  ...
  if (
    ...
    window.addEventListener('error', function (e) {
      ;(R = e.filename), (A = e.error)
    })
    var I = location.origin
  }
  E.createScript = function (e) {
  ...
  ;(E.register = function (e, t) {
    ...
    (E.instantiate = function (t, n) {
      var r = T[t]
      if (r) return delete T[t], r
      var i = this
      return new Promise(function (r, o) {
        var s = E.createScript(t)
        s.addEventListener('error', function () {
          o(Error(e(3, 'Error loading ' + t + (n ? ' from ' + n : ''))))
        }),
          s.addEventListener('load', function () {
            if ((document.head.removeChild(s), R === t)) o(A)
            else {
              var e = i.getRegister()
  ...
  var $ = 'undefined' != typeof Symbol && Symbol.iterator
  E.entries = function () {
    var e,
      t,
      n = this,
