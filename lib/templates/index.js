...
const umi_qiankun_1 = tslib_1.__importDefault(require("./umi-qiankun"));
...
class TemplateWeb extends fbi_1.Template {
    constructor(factory) {
        ...
        this.templates = [
            ...
            new umi_qiankun_1.default(this.factory)
        ];
        this.projectInfo = {};
    }
    async gathering(flags) {
        ...
        this.projectInfo = await this.prompt([
            ...
            },
            {
                ...
                choices: [
                    { name: const_1.UMI_QIANKUN_MAIN_FEATURE_ID, value: true },
                    { name: const_1.UMI_QIANKUN_SUB_FEATURE_ID, value: true }
                ],
                result(name) {
                    return {
                        [name]: true
        ...
        if (this.projectInfo.language === const_1.REACT_STR) {
            ...
            templateId = const_1.UMI_QIANKUN_TEMPLATE_ID;
        }
        this.projectInfo = {
            ...this.projectInfo,
            templateId
