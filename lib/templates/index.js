...
const graphql_1 = tslib_1.__importDefault(require("./react/graphql"));
...
class TemplateWeb extends fbi_1.Template {
    constructor(factory) {
        ...
        this.templates = [
            ...
            new graphql_1.default(this.factory)
        ];
        this.projectInfo = {};
    }
    async gathering(flags) {
        ...
        this.projectInfo = await this.prompt([
            ...
            },
            {
                ...
                choices: [
                    { name: const_1.REACT_GRAPHQL_TEMPLATE_ID, value: true },
                    { name: const_1.REACT_OPENAPI_TEMPLATE_ID, value: true }
                ]
            },
