...
class CommandServe extends fbi_1.Command {
    ...
    async run(flags, unknown) {
        ...
        try {
            ...
            const server = new webpack_dev_server_1.default(compiler, Object.assign(Object.assign({}, defaults_1.WEBPACK_DEV_CONFIG), { writeToDisk: template === 'micro-vue' ? true : false }));
