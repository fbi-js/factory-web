...
const defaults_1 = require("../config/constant/defaults");
...
class CommandServe extends fbi_1.Command {
    ...
    async run(flags, unknown) {
        ...
        try {
            ...
            const config = await config_1.resolveWebpackConfig(factory.template, Object.assign(Object.assign({}, flags), { factory,
                paths }));
