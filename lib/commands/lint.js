...
class CommandLint extends fbi_1.Command {
    constructor(factory) {
        super();
        this.factory = factory;
        this.id = 'lint';
        this.alias = 'l';
        this.description = 'lint code with eslint';
        this.args = '';
        this.flags = [];
    }
    run(flags, unknown) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.lintWithEslint(factory);
            }
            catch (err) {
