...
const vue_1 = __importDefault(require("./template-renders/vue"));
const react_1 = __importDefault(require("./template-renders/react"));
const micro_main_1 = __importDefault(require("./template-renders/micro-main"));
const micro_vue_1 = __importDefault(require("./template-renders/micro-vue"));
const micro_react_1 = __importDefault(require("./template-renders/micro-react"));
