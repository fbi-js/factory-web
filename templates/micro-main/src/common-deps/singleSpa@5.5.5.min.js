  ...
  return {
    execute: function () {
      ...
      var p = t('NOT_LOADED', 'NOT_LOADED'),
        ...
        T = t('LOAD_ERROR', 'LOAD_ERROR'),
        O = t('SKIP_BECAUSE_BROKEN', 'SKIP_BECAUSE_BROKEN')
      function P(t) {
        return t.status === g
      }
      function b(t) {
        ...
        return function (t) {
          return e.reduce(function (e, i, u) {
            return e.then(function () {
              var e = i(t)
              return L(e) ? e : Promise.reject(f(15, !1, r, o, n, u))
            })
          }, Promise.resolve())
        }
      }
          ...
          return t.status !== v
            ...
            : (I ||
              ...
              q(t, 'mount')
                ...
                .catch(function (e) {
                  return (t.status = g), j(t, !0).then(r, r)
                  function r() {
                    if (n) throw l(e, t, O)
                    return a(e, t, O), t
                  }
      ...
      function $(t, n) {
        ...
        var p,
          ...
          w = (s = s.then(function (t) {
            ...
            if (!U(t.bootstrap)) throw Error(f(9, !1, n))
          ...
          return t.loadPromise
            ...
            : ((t.status = h),
              (t.loadPromise = Promise.resolve()
                .then(function () {
                  var o = t.loadApp(K(t))
                  if (!L(o)) throw ((r = !0), Error(f(33, !1, A(t))))
      ...
      function Lt() {
        ...
        var e,
          ...
          c = o.appsToLoad,
          s = o.appsToMount
        return xt() ? ((Dt = !0), (e = u.concat(c, a, s)), l()) : ((e = c), f())
        function f() {
          return Promise.resolve().then(function () {
            var t = c.map(X)
